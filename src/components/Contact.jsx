    ...
    <section id="contacto" className="mb-16">
      ...
      <div className="bg-slate-900/70 border border-slate-800 rounded-2xl p-6 max-w-2xl">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a href="mailto:villaplana02@gmail.com" className="text-emerald-300 hover:text-emerald-200 transition">
                villaplana02@gmail.com
              </a>
            </div>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-slate-700">
          <a
            href="mailto:villaplana02@gmail.com"
